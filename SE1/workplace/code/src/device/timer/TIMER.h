...
#define     timer_sleep_seconds(A,B)          (timer_delay(A,(((getSystemClock()))/SECOND)*B))
#define     timer_sleep_miliseconds(A,B)      (timer_delay(A,(((getSystemClock()))/MILI)*B))
#define     timer_sleep_microseconds(A,B)     (timer_delay(A,(((getSystemClock()))/MICRO)*B))
