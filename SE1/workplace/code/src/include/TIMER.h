...
#define     timer_sleep_seconds(A,B)          (timer_delay(A,(XCLOCK/SECOND)*B))
#define     timer_sleep_miliseconds(A,B)      (timer_delay(A,(XCLOCK/MILI)*B))
#define     timer_sleep_microseconds(A,B)     (timer_delay(A,(XCLOCK/MICRO)*B))
