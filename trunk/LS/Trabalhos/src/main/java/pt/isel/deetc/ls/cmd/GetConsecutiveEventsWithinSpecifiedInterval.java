...
public class GetConsecutiveEventsWithinSpecifiedInterval extends GetEventsAll {
    private static final String _NAME = "get-consecutive-events-within-specified-interval";
    private static final String _DESCRIPTION = "Show the information of a set of Event between a period of time that are consecutive";
    
    /**
     * @param name
     * @param description
     */
    public GetConsecutiveEventsWithinSpecifiedInterval() {
