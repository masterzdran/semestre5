...
public abstract class FormatedOutput<T> extends Output<T> {
	// HTML Common Tags
	...
	private final static String _beginHeaderHtmlTable = "<th>";
	private final static String _endHeaderHtmlTable = "</th>";
	...
	private final static String _beginHeaderCmdLineTable = "[";
	private final static String _endHeaderCmdLineTable = "]";
	...
	private final static String _beginHeaderWikiTable = "";
	private final static String _endHeaderWikiTable = "";
	...
	public FormatedOutput(ArrayList<T> list) {
		super(list);
	}

	public void showAsHtmlTable() {
		generateCustomDocument(_beginHtmlDocument, _endHtmlDocument,
				_beginRecordsHtmlTable, _endRecordsHtmlTable,
				_beginHeaderHtmlTable, _endHeaderHtmlTable,
				_beginRecordHtmlTable, _endRecordHtmlTable,
				_beginFieldHtmlTable, _endFieldHtmlTable);
	}

	public void showAsHtmlList() {
		generateCustomDocument(_beginHtmlDocument, _endHtmlDocument,
				_beginRecordsHtmlList, _endRecordsHtmlList,
				"", "",
				_beginRecordHtmlList, _endRecordHtmlList,
				_beginFieldHtmlList,  _endFieldHtmlList);
	}

	public void showAsCommandLineTable() {
		generateCustomDocument(_beginCommandLineDocument, _endCommandLineDocument, 
				_beginRecordsCmdLineTable, 	_endRecordsCmdLineTable,
				_beginHeaderCmdLineTable, _endHeaderCmdLineTable,
				_beginRecordCmdLineTable, _endRecordCmdLineTable, 
				_beginFieldCmdLineTable, _endFieldCmdLineTable);
	}

	public void showAsCommandLineList() {
		generateCustomDocument(_beginCommandLineDocument, _endCommandLineDocument, 
	...
	public void showAsWikiTable() {
		generateCustomDocument(_beginWikiDocument, _endWikiDocument,
				_beginRecordsWikiTable, _endRecordsWikiTable,
				_endHeaderWikiTable, _endRecordWikiTable, 
				_beginRecordWikiTable, _beginHeaderWikiTable,
				_beginFieldWikiTable, _endFieldWikiTable);
	}

	public void showAsWikiList() {
		generateCustomDocument(_beginWikiDocument, _endWikiDocument,
				_beginRecordsWikiList, _endRecordsWikiList,
				 "", "",
				_beginRecordWikiList, _endRecordWikiList,
