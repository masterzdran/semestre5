...
#define     sleep_seconds(A,B)          (timer_delay(A,(CCLK/SECOND)*B))
#define     sleep_miliseconds(A,B)      (timer_delay(A,(CCLK/MILI)*B)
#define     sleep_microseconds(A,B)     (timer_delay(A,(CCLK/MICRO)*B))
